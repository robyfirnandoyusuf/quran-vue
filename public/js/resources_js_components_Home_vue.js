      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this.axios.get('http://127.0.0.1:8000/api/v1/get-surah').then(function (response) {
                console.log(JSON.parse(response.data.data).data);
                _this.surah = JSON.parse(response.data.data).data;
...
var render = function render() {
  ...
  }, _vm._l(_vm.surah, function (s, index) {
    return _c("div", {
      key: index,
      staticClass: "col-12 col-md-6 col-lg-4 p-1"
    }, [_c("router-link", {
      attrs: {
        to: {
          name: "detail",
      ...
      staticClass: "p-4 bg-success text-white",
      staticStyle: {
        "background-color": "#8BC34A"
      }
    }, [_c("p", {
      staticClass: "font-weight-bold"
    }, [_vm._v(_vm._s(s.nomor) + " " + _vm._s(s.namaLatin))]), _vm._v(" "), _c("p", {
      staticClass: "text-right font-weight-bold",
      staticStyle: {
        "font-family": "'Lateef', cursive",
        "font-size": "3rem"
      }
    }, [_vm._v(_vm._s(s.nama))]), _vm._v(" "), _c("p", {
      staticClass: "text-right small mt-3"
    }, [_vm._v(_vm._s(s.tempatTurun) + " • " + _vm._s(s.arti))])])])], 1);
  }), 0)]);
};
